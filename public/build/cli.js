var app = (function () {
    ...
    */
    ...
    var debug$5 = browser('socket.io-client:manager');
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Cli> was created with unknown prop '${key}'`);
    	});
