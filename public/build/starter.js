var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*menuOpen*/ 2 && svg0_class_value !== (svg0_class_value = "" + ((/*menuOpen*/ ctx[1] ? "hidden" : "block") + " h-6 w-6"))) {
    				attr_dev(svg0, "class", svg0_class_value);
    			}

    			if (!current || dirty & /*menuOpen*/ 2 && svg1_class_value !== (svg1_class_value = "" + ((/*menuOpen*/ ctx[1] ? "block" : "hidden") + " h-6 w-6"))) {
    				attr_dev(svg1, "class", svg1_class_value);
    			}

    			if (!current || dirty & /*menuOpen*/ 2 && div8_class_value !== (div8_class_value = "" + ((/*menuOpen*/ ctx[1] ? "block" : "hidden") + " md:hidden"))) {
    ...
    class Menu extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { selectedMenu: 0 });
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, Menu });
    	return [];
    }
    ...
    const file$2 = "src\\components\\contactUs.svelte";
    ...
    function create_default_slot$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*resp*/ ctx[3]) return create_if_block$1;
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, resp, message, email, name*/ 527) {
    				menu_changes.$$scope = { dirty, ctx };
    			}
    ...
    /* src\starter\Starter.svelte generated by Svelte v3.31.0 */

    const { console: console_1$2 } = globals;
    const file$3 = "src\\starter\\Starter.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			attr_dev(div, "id", "foo");
    			attr_dev(div, "class", "svelte-1dm37g0");
    			add_location(div, file$3, 27, 0, 449);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<Starter> was created with unknown prop '${key}'`);
    	});
    ...
    class Starter extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
